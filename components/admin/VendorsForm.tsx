  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      try {
        ...
        console.log('Saving vendors data:', JSON.stringify(vendorsList).length, 'bytes');
        ...
        Alert.alert(
          'Gagal Menyimpan',
          'Terjadi kesalahan saat menyimpan data. Coba kurangi ukuran foto atau hapus beberapa vendor.',
          [{ text: 'OK' }]
        );
      } finally {
        setLoading(false);
